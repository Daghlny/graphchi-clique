...
CPP = g++
CPPFLAGS = -g -O3 $(INCFLAGS)  -fopenmp -lz -Wall -Wno-strict-aliasing 
#CPPFLAGS = -g -ggdb -O0 $(INCFLAGS)  -fopenmp -lz -Wall -Wno-strict-aliasing 
LINKERFLAGS = -lz
...
all: apps tests 
apps: example_apps/clique_bfs_dynamic example_apps/connectedcomponents example_apps/pagerank example_apps/pagerank_functional example_apps/communitydetection example_apps/unionfind_connectedcomps example_apps/stronglyconnectedcomponents example_apps/trianglecounting example_apps/randomwalks example_apps/minimumspanningforest
#apps: clique/clique_bfs_dynamic
